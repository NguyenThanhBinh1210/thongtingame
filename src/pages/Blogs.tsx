  ...
  const filteredItems = useMemo(() => {
    const filtered = blogs?.filter((blog) => {
      const matchesSearch =
        ...
        blog.categoryIdLevel3?.name?.toLowerCase().includes(searchTerm.toLowerCase())
          ...
          <TableBody>
            {filteredItems?.map((item: Tour, index: number) => (
              <TableRow key={index + 1}>
                ...
                <TableCell>
                  <img className='aspect-square object-cover' src={item.thumbnail} alt='anh' />
                </TableCell>
                ...
                <TableCell>
                  <div className='space-y-1'>
                    ...
                    <div className='text-xs line-clamp-3' dangerouslySetInnerHTML={{ __html: item.duration || item.content }}></div>
                  </div>
                </TableCell>
                <TableCell>
